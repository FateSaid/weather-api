...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.bunny.net/css?family=abril-fatface:400);"]);
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.bunny.net/css?family=actor:400);"]);
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAIA;;EAEE,YAAY;EACZ,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,4BAA4B;EAC5B,4BAA4B;EAC5B,2BAA2B;EAC3B,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,kBAAkB;EAClB,eAAe;EACf,iCAAiC;EACjC,yBAAyB;EACzB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,WAAW;EACX,6BAA6B;AAC/B;;AAEA;EACE,iBAAiB;EACjB,8BAA8B;EAC9B,oBAAoB;EACpB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,YAAY;EACZ,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,WAAW;EACX,sBAAsB;EACtB,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,uBAAuB;EACvB,YAAY;EACZ,8BAA8B;EAC9B,aAAa;EACb,YAAY;AACd;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gCAAgC;EAChC,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,UAAU;EACV,mBAAmB;EACnB,kBAAkB;EAClB;;;;GAIC;EACD,sBAAsB;EACtB,gDAAgD;EAChD,0BAA0B;EAC1B,kCAAkC;AACpC;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,kBAAkB;AACpB;;AAEA;;EAEE,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,gCAAgC;AAClC","sourcesContent":["@import url(https://fonts.bunny.net/css?family=abril-fatface:400);\n@import url(https://fonts.bunny.net/css?family=actor:400);\n@import url(https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap);\n\nhtml,\nbody {\n  height: 100%;\n  margin: 0;\n  overflow-x: hidden;\n}\n\nbody {\n  display: grid;\n  grid-template-columns: 3fr 1fr;\n  background-repeat: no-repeat;\n  background-attachment: fixed;\n  background-position: center;\n  background-size: cover;\n}\n\n.title {\n  grid-column: 1/2;\n  grid-row: 1/2;\n  text-align: center;\n  font-size: 4rem;\n  font-family: \"Nunito\", sans-serif;\n  font-optical-sizing: auto;\n  font-style: normal;\n}\n\n.side-info {\n  grid-column: 2/3;\n  grid-row: 1/3;\n  border: 1px solid #000;\n  backdrop-filter: blur(25px);\n}\n\n.weather-content {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  height: 40%;\n  justify-content: space-evenly;\n}\n\n.date {\n  margin-left: 30px;\n  border-bottom: 1px solid black;\n  padding-bottom: 10px;\n  font-size: 2rem;\n  width: fit-content;\n}\n\n.forecast-avgtemp-c {\n  font-size: 1.4rem;\n}\n\n.forecast-icon {\n  text-align: center;\n}\n\n::placeholder {\n  color: black;\n  font-size: larger;\n}\n\n.forecast-container {\n  display: flex;\n  height: 70%;\n  flex-direction: column;\n  justify-content: space-evenly;\n}\n\n.forecast {\n  display: flex;\n  justify-content: space-evenly;\n  align-items: center;\n}\n\n.search {\n  display: flex;\n  justify-content: center;\n}\n\ninput {\n  border: none;\n  background: transparent;\n  border: none;\n  border-bottom: 1px solid black;\n  padding: 10px;\n  color: black;\n}\n\n.side-content {\n  height: 40%;\n}\n\n.side-content > h3 {\n  font-family: \"Actor\", sans-serif;\n  text-align: center;\n}\n\n.content {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  grid-row: 2/3;\n}\n\n.container {\n  display: flex;\n  justify-content: space-evenly;\n  width: 80%;\n  align-items: center;\n  text-align: center;\n  background: linear-gradient(\n    50deg,\n    rgba(255, 255, 255, 0.4) 12%,\n    rgba(255, 255, 255, 0.1) 77%\n  );\n  background-blend-mode:;\n  box-shadow: 0px 4px 24px 1px rgba(0, 0, 0, 0.28);\n  backdrop-filter: blur(5px);\n  -webkit-backdrop-filter: blur(5px);\n}\n\n.temp {\n  font-size: 10rem;\n}\n\n.city {\n  font-size: 5.2rem;\n}\n\np {\n  margin: 0;\n}\n\n.location {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  text-align: center;\n}\n\nh2,\nh5 {\n  margin: 0;\n}\n\n.weather-detail {\n  text-align: center;\n  font-family: \"Actor\", sans-serif;\n}\n"],"sourceRoot":""}]);
// Exports
...
module.exports = __webpack_require__.p + "69c0677dc00063aafc5d.jpg";
...
module.exports = __webpack_require__.p + "1a3265aa5c3390d9e229.jpg";
...
/* harmony import */ var _raining_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./raining.jpg */ "./src/raining.jpg");
/* harmony import */ var _night_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./night.jpg */ "./src/night.jpg");
...
function addForecast(array) {
  ...
  array.forEach((obj) => {
    ...
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(new Date(obj.date), "eeee");
...
function checkWeather(isDay, text) {
  ...
  if (isDay === 1 || weather.includes("sunny") || weather.includes("Sunny")) {
    ...
    body.style.backgroundImage = `url(${_raining_jpg__WEBPACK_IMPORTED_MODULE_3__})`;
    body.style.color = "white";
  } else if (isDay === 0) {
    body.style.backgroundImage = `url(${_night_jpg__WEBPACK_IMPORTED_MODULE_4__}`;
    body.style.color = "white";
  }
}
...
function createDom(
  ...
  //date
  const date = document.createElement("div");
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(new Date(), "eeee, cc, LLL, yy");
...
function deleteSearch(search) {
  ...
  (0,_logic_js__WEBPACK_IMPORTED_MODULE_1__.fetching)(address, createDom, addForecast);
}
